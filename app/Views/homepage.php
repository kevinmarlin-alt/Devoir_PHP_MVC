        ...
        foreach($travels as $travel): ?>
            <tr data-id-travel="<?= $travel->getId() ?>">
                ...
                <?php if(isset($_SESSION['user'])): ?>
                    <td>
                        <!-- Read button -->
                        <a href="#" class="table__travel--read" data-bs-toggle="modal" data-bs-target="#travelDetailModal">
                        ...
                        if($employeeId == $user['id']): ?>
                            <!-- Update button -->
                            <a href="/travels/update/?id=<?= $travel->getId() ?>">
                            ...
                            <!-- Delete button -->
                            <a href="#" class="table__travel--delete">
